...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
        ...
        System.out.println("*********retrieve elements from linked lists************");
        System.out.println("first frnd in list :"+friends.getFirst());
        System.out.println("last frnd in list :"+friends.getLast());
        System.out.println("search a frnd in position 3 :"+friends.get(3));
        System.out.println("delete last frnd in list :"+friends.remove("Walt"));
        System.out.println("find position of John :"+friends.indexOf("John"));
        System.out.println("linked lists contents :");
